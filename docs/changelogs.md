...
readers can scan features, fixes, and breaking changes quickly.

Tip: Narrate the impact. Focus each bullet on the outcome a user gets, then link
to docs or guides that help them try it immediately.
